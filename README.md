...
# 0074springboot电影评论网站系统设计与实现

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV16ia6epENY?p=75)
...
|dianyingleixing|varchar(200)|否||电影类型|
表4.2 电影信息
...
|zhipiandiqu|varchar(200)|是|NULL|制片地区|
|yuyan|varchar(200)|是|NULL|语言|
|shangyingriqi|date|是|NULL|上映日期|
|pianzhang|varchar(200)|是|NULL|片长|
|pingfen|varchar(200)|是|NULL|评分|
|dianyingjieshao|longtext|是|NULL|电影介绍|
|dianyingbofang|varchar(200)|是|NULL|电影播放|
